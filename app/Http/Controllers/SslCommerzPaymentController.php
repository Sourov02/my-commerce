...
//                customers ta hocche database er table er naam ar email ta hocche column
        ...
        OrderDetail::newOrderDetails(Order::orderBy('id', 'desc')->first()->id);
        #ekhane order id ta dhorte partesilam na... tai Order id ta evabe descending order e niye nisi,,, first() ekta row e dhore r eta prothom e aisha porbe,,,r get() dile shob gula row niye nito.
