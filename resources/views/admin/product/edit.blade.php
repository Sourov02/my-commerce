                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{ route('product.update', ['id' => $product->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$product->name}}" name="name" id="" placeholder="Name">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$product->model}}" name="model" id="" placeholder="Mode Name">
                            </div>
                        </div>
                        <div class="form-group row">
...
{{--                                    otherImages ta hocche Eloquent orm er function--}}
