                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            ...
                            <div class="xzoom-thumbs">
                                ...
                                <a href="{{asset($otherImages->image)}}"><img class="xzoom-gallery" width="80" src="{{asset($otherImages->image)}}"  xpreview="{{asset($otherImages->image)}}" title="The description goes here"></a>
                                @endforeach
                            </div>
                        </div>
