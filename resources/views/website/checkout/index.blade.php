...
{{--                                                    validation er jonno use korsilam--}}
...
{{--                                                        validation er jonno use korsilam--}}
                            ...
                            <div class="tab-pane fade show active px-3" id="online">
                                <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" id="address" name="delivery_address" placeholder="Delivery Address" required></textarea>
                                        <div class="invalid-feedback">
